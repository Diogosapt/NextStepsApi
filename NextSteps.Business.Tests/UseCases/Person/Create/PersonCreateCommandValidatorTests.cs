...
{
    [TestClass]
    public class PersonCreateCommandValidatorTests
    {
        private static PersonCreateCommandValidator validator;
        ...
        {
            validator = new PersonCreateCommandValidator();
        }
        ...
        public void Should_not_have_error_when_All_Parameters_Ok()
        {
            ...
            var command = new PersonCreateCommand(person);
